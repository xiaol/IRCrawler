...
class BaiduIfengSpider(scrapy.Spider):
    name='baidu.ifeng.com'
    # allowed_domains=['google.com.hk']
    source_site="凤凰新闻"

    def __init__(self, url=None, topic=None, *args, **kwargs):

        super(BaiduIfengSpider, self).__init__(*args, **kwargs)
        # keywords = []
        self.start_urls=[]
        topic = topic.split('s')
        ...
        self.start_urls.append('https://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=1&rsv_idx=2&tn=baiduhome_pg&wd=site:ifeng.com++%s'%self.keyword)
