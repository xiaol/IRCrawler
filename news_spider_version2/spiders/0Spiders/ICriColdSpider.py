...
class ICriColdSpider(scrapy.Spider):
    name='ICriColdSpider'
    ...
    page_url_pattern=re.compile(r'^http://news.cri.cn/\d+-\d+-\d+.*?\.htm[l]?')
    non_page_url_pattern=re.compile(r'^http://i.cri.cn/popularnews')
