...
class PansciColdSpider(scrapy.Spider):
    name='PansciColdNews'
    allowed_domains=['pansci.tw']

    start_urls=['http://pansci.tw/archives/category/type/living','http://pansci.tw/archives/category/type/medicine-disease/health',
                'http://pansci.tw/archives/category/type/humanbeing','http://pansci.tw/archives/category/type/scicomm',
                'http://pansci.tw/archives/category/type/technology']
