...
class AliBuyBuySpider(scrapy.Spider):
    name='AliBuyBuyNews'
    ...
    # start_urls=['http://www.alibuybuy.com/posts/86923.html']
    ...
    page_url_pattern=re.compile(r'^http://www\.alibuybuy\.com/posts/\d+\.html$')
